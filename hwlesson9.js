...
//     div.innerText= `${element.title} - duration ${ element.monthDuration} months`
...
//     div.innerHTML =  (`<h2>${member.name + ' ' + member.surname}</h2><p>${member.age}</p><p>${member.info}</p><img src="${member.photo}" width="200">`)
//     document.body.appendChild(div)
// }
...
//     hourDuration.innerHTML = item.hourDuration + " hours"
